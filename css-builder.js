define(['require', './normalize'], function(req, normalize) {
  ...
  cssAPI.write = function(pluginName, moduleName, write, parse) {
    ...
    if (separateCSS)
      ...
      write("requirejs.s.contexts._.nextTick = function(f){f()}; require(['require-css/css'], function(css) { css.addBuffer('" + resourceName + "'); }); requirejs.s.contexts._.nextTick = requirejs.nextTick;");
  }
  ...
  cssAPI.onLayerEnd = function(write, data, parser) {
    ...
    if (separateCSS) {
      ...
      write("requirejs.s.contexts._.nextTick = function(f){f()}; require(['require-css/css'], function(css) { css.setBuffer('" + css + (parser ? "', true" : "'") + "); }); requirejs.s.contexts._.nextTick = requirejs.nextTick; ");
    }
